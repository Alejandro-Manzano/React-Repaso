  ...
  return (
    <div className="bg-white cursor-pointer w-56 h-60">
      <figure className='relative mb-2 w-full h-4/5'>
        ...
        <img className='w-full h-full object-cover rounded-lg' src="https://cdn.shopify.com/s/files/1/0635/4475/4432/files/CHIAMA_SILVER_2048x2048.jpg?v=1662563828" alt="headphones"></img>
